                ...
                <div className="resume-container">
                    <Row>
                        <Col lg={6} className="card-col">
                            <div className="card-o" style={{ backgroundColor: "#FFC94D" }} data-aos="fade-down-right" data-aos-duration="2000" >
                        ...
                        <Col lg={6} className="card-col">
                            <div className="card-o text-white" style={{ backgroundColor: '#282C35' }} data-aos="fade-down-left" data-aos-duration="1000">
                                <h5>WORK EXPERIENCE</h5>
                    ...
                    <Row className="resume-row">
                        <Col lg={6} className="card-col">
                            <div className="card-o text-white" style={{ backgroundColor: "#6C58E8" }} data-aos="slide-right" data-aos-duration="500">
                                <h5>EDUCATION</h5>
                        ...
                        <Col lg={6} className="card-col">
                            <div className="card-o" style={{ backgroundColor: '#FFFFFF' }} data-aos="slide-left" data-aos-duration="500">
                                <h5>EDUCATION</h5>
                    ...
                    <Row className="card-row" style={{ marginLeft: '0%' }} data-aos="flip-left" data-aos-duration="2000">
